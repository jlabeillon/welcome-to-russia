...
class VolgogradFixtures extends Fixture
{
    public function load(ObjectManager $manager)
    {
        ...
        $hotelVolgograd1->setAddress('Ulitsa Kachentsev 94A, 400010 Volgograd, Russia');
        ...
        $hotelVolgograd2->setAddress('Angarskaya, 103, 400081 Volgograd, Russia');
        ...
        $hotelVolgograd3->setAddress('ul. 40 let VLKSM, 76, Volgograd, Volgogradskaya oblast, Russia, 400080');
        ...
        $hotelVolgograd4->setAddress('ul. 40 let VLKSM, 76, Volgograd, Volgogradskaya oblast, Russia, 400080');
        ...
        $hotelVolgograd5->setEmail('bart@plaza-vlg.ru');
        ...
        $hotelVolgograd5->setAddress('Novoyzenskaya Street 2/1, 400120 Volgograd, Russia');
        ...
        $hotelVolgograd6->setAddress('Angarskaya Street 137/181, 400081 Volgograd, Russia');
        ...
        $hotelVolgograd7->setEmail('hampton@stoliya.ru');
        ...
        $hotelVolgograd7->setAddress('Profsoyuznaya ulitsa, 13, Volgograd, Volgogradskaya oblast, Russia, 400001');
        ...
        $hotelVolgograd8->setName('Hilton Garden Inn Volgograd');
        $hotelVolgograd8->setEmail('reservation@hgivolgograd.ru');
        $hotelVolgograd8->setShortdescription('Located a 5-minute walk from the Volga River Embankment and 1.8 km from Mamayev Kurgan Memorial, Hilton Garden Inn Volgograd features a fitness centre and a 24-hour front desk. Free WiFi is available throughout the property.');
        $hotelVolgograd8->setDescription('Located a 5-minute walk from the Volga River Embankment and 1.8 km from Mamayev Kurgan Memorial, Hilton Garden Inn Volgograd features a fitness centre and a 24-hour front desk. Free WiFi is available throughout the property. The rooms provide air conditioning, a mini-fridge, a safety deposit box, a flat-screen TV with satellite channels, an electric kettle and complimentary tea/coffee.
        Hilton Garden Inn Volgograd offers buffet and cooked-to-order breakfast, as well as all-day dining at The Garden Grille & Bar. The Pavilion Pantry Convenience Mart offers snacks and souvenirs. Other facilities include self-service laundry, on-site shop, conference hall and meeting facilities.');
        ...
        $hotelVolgograd8->setAddress('pr. V.I. Lenina, 56a, Volgograd, Volgogradskaya oblast, Russia, 400005');
        ...
        $hotelVolgograd9->setEmail('volgogradskaya-hotel@mail.ru');
        ...
        $hotelVolgograd9->setAddress('ul. im. Rokossovskogo, 56, Volgograd, Volgogradskaya oblast, Russia, 400012');
