...
class KaliningradFixtures extends Fixture
{
    public function load(ObjectManager $manager)
    {
        ...
        $hotelKaliningrad1->setEmail('email@address.fake');
        ...
        $hotelKaliningrad2->setEmail('email@address.fake');
        ...
        $hotelKaliningrad4->setEmail('email@address.fake');
        ...
        $hotelKaliningrad5->setEmail('email@address.fake');
        ...
        $hotelKaliningrad6->setName('Chaika Hotel');
        $hotelKaliningrad6->setEmail('email@address.fake');
        $hotelKaliningrad6->setShortdescription('Chaika Hotel is situated in historical Kaliningrad, just outside the city centre. There is public transport available from outside the hotel. Chaika offers free parking and free Wi-Fi.');
        $hotelKaliningrad6->setDescription('Chaika Hotel is situated in historical Kaliningrad, just outside the city centre. There is public transport available from outside the hotel. Chaika offers free parking and free Wi-Fi. There is a choice of spacious rooms and suites at Chaika Hotel. All rooms have modern facilities, and a work desk. There is also a bar and 24-hour reception service. The hotel is 20 km from Kaliningrad Khrabrovo Airport.');
        ...
        $hotelKaliningrad7->setEmail('email@address.fake');
        ...
        $hotelKaliningrad8->setEmail('email@address.fake');
        ...
        $hotelKaliningrad9->setEmail('email@address.fake');
