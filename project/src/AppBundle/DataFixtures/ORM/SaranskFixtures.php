...
class SaranskFixtures extends Fixture
{
    public function load(ObjectManager $manager)
    {
        ...
        $hotelSaransk2->setEmail('email@address.fake');
        ...
        $hotelSaransk4->setEmail('email@address.fake');
        ...
        $hotelSaransk5->setEmail('email@address.fake');
        ...
        $hotelSaransk6->setEmail('email@address.fake');
        ...
        $hotelSaransk7->setEmail('email@address.fake');
