...
const Transport = () => (
  <div className="container">
    ...
    <div className="col-xs-12 page-container">
      ...
      <p id="reponse1">Mieux vaut se renseigner à l'avance auprès d'un tiers pour savoir précisément quelle ligne empunter. On achète son ticket ("talon") auprès du conducteur et on le composte à une petite machine située près des fenêtres. On peut aussi acheter un coupon, valable pour tous les transports en commun, aux guichets du métro.</p>
      ...
      <p id="reponse3"> Ils sillonnent la Moskova. Les embarcadères sont répartis tout au long des rives. Les prix sont modiques et c’est un moyen idéal pour avoir un rapide aperçu des principaux points touristiques. Certains grands hôtels organisent des croisières fluviales avec une formule dîner et spectacle. A Moscou, Flotilla Radisson Royal Moscow, l’une des meilleures sociétés de croisière d’Europe, vous fait découvrir les principaux sites touristiques de la ville, lors d’une mini croisière de 2h30 sur la Moskova.</p>
