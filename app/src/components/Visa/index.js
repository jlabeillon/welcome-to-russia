      ...
      <div className="container">
        ...
        <div className="row">
          ...
          <div className="col-xs-12" id="visa-container">
            ...
            <p id="reponse4">Les enfants devront également posséder leur Fan-ID propre. Pour obtenir ce passeport, le représentant légal de l’enfant devra soumettre une demande pour un enfant de moins de 14 ans, et devra donner son consentement pour le traitement des données personnelles de l’enfant. Il faudra dans ce cas se munir de l’original du certificat de naissance de l’enfant, de la pièce d’identité du représentant légal de l’enfant, d’un billet ou une preuve de l’achat du billet.

            Sachez également qu’il sera possible d’aller retirer les Fan-ID pour vos amis, parents ou conjoints sous présentation d’une photocopie de la pièce d’identité de la personne, d’une procuration dûment remplie et de la pièce d’identité du mandataire.

            Si vous posséder plusieurs places, il ne vous sera pas demandé un Fan ID pour chaque place. Il suffira d’associer votre Fan ID à vos différentes places.</p>
