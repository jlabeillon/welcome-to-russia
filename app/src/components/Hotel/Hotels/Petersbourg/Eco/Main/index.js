    ...
    <div className="row">
      <div className="col-xs-12">
        <NavLink to="/city/petersbourg/hotels/eco/piter">
          <img className="hotels-image" alt="piters" src="/images/hotels/Petersbourg/petersbourg-eco-piters.jpg" />
          <p className="hotels-description">Piter’s house na Nevskom is located in the Tsentralny district district in Saint Petersburg, 2.7 km from State Russian Museum. Each room has a flat-screen TV. Certain units feature a seating area for your convenience. You will find a kettle in the room. Every room is equipped with a private bathroom. For your comfort, you will find slippers, free toiletries and a hairdryer. Piters house na Nevskom features free WiFi throughout the property.</p>
        </NavLink>
      </div>
    </div>
    ...
    <div className="row">
      <div className="col-xs-12">
        <NavLink to="/city/petersbourg/hotels/eco/capital">
          <img className="hotels-image" alt="capital" src="/images/hotels/Petersbourg/petersbourg-eco-capital.jpg" />
    ...
    <div className="row">
      <div className="col-xs-12">
        <NavLink to="/city/petersbourg/hotels/eco/gora">
          <img className="hotels-image" alt="gora" src="/images/hotels/Petersbourg/petersbourg-eco-gora.jpg" />
