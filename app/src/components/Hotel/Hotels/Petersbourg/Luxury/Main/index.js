    ...
    <div className="row">
      <div className="col-xs-12">
        <NavLink to="/city/petersbourg/hotels/luxury/four">
          <img className="hotels-image" alt="four" src="/images/hotels/Petersbourg/petersbourg-luxury-four.jpg" />
    ...
    <div className="row">
      <div className="col-xs-12">
        <NavLink to="/city/petersbourg/hotels/luxury/lotte">
          <img className="hotels-image" alt="lotte" src="/images/hotels/Petersbourg/petersbourg-luxury-lotte.jpg" />
    ...
    <div className="row">
      <div className="col-xs-12">
        <NavLink to="/city/petersbourg/hotels/luxury/belmond">
          <img className="hotels-image" alt="belmond" src="/images/hotels/Petersbourg/petersbourg-luxury-belmond.jpg" />
