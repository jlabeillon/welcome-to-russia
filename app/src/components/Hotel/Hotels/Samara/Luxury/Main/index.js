        ...
        {/* Header */}
          ...
          <div className="row">
            <div className="col-xs-12">
              ...
              <img className="hotels-image" src="/images/hotels/Samara/samara-luxury-holiday.jpg" />
          ...
          <div className="col-xs-12">
            ...
            <img className="hotels-image" src="/images/hotels/Samara/samara-luxury-renaissance.jpg" />
          ...
          <div className="col-xs-12">
            ...
            <img className="hotels-image" src="/images/hotels/Samara/samara-luxury-glinka.jpg" />
