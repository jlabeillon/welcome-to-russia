    ...
    <div className="row">
      <div className="col-xs-12">
        <NavLink to="/city/samara/hotels/eco/elyzium">
          <img className="hotels-image" alt="elyzium-hotel" src="/images/hotels/Samara/samara-eco-elyzium.jpg" />
    ...
    <div className="row">
      <div className="col-xs-12">
        <NavLink to="/city/samara/hotels/eco/zagora">
          <img className="hotels-image" alt="zagora-hotel" src="/images/hotels/Samara/samara-eco-zagora.jpg" />
    ...
    <div className="row">
      <div className="col-xs-12">
        <NavLink to="/city/samara/hotels/eco/volna">
          <img className="hotels-image" alt="volna-hotel" src="/images/hotels/Samara/samara-eco-volna.jpg" />
