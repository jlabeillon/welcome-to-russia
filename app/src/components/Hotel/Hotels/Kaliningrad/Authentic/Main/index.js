...
// Code
const KaliningradAuthenticMain = () => (
    ...
    <div className="row">
      <div className="col-xs-12">
        <NavLink to="/city/kaliningrad/hotels/authentic/tchaikovsky">
          <img className="hotels-image" alt="tchaikovsky" src="/images/hotels/Kaliningrad/kaliningrad-authentic-tchaikovsky.jpg" />
    ...
    <div className="row">
      <div className="col-xs-12">
        <NavLink to="/city/kaliningrad/hotels/authentic/chaika">
          <img className="hotels-image" alt="chaika" src="/images/hotels/Kaliningrad/kaliningrad-authentic-chaika.jpg" />
    ...
    <div className="row">
      <div className="col-xs-12">
        <NavLink to="/city/kaliningrad/hotels/authentic/usadba">
          <img className="hotels-image" alt="usadba" src="/images/hotels/Kaliningrad/kaliningrad-authentic-usadba.jpg" />
