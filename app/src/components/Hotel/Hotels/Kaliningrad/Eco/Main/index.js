    ...
    <div className="row">
      <div className="col-xs-12">
        <NavLink to="/city/kaliningrad/hotels/eco/cottbus">
          <img className="hotels-image" alt="cottbus" src="/images/hotels/Kaliningrad/kaliningrad-eco-cottbus.jpg" />
    ...
    <div className="row">
      <div className="col-xs-12">
        <NavLink to="/city/kaliningrad/hotels/eco/traktir">
          <img className="hotels-image" alt="traktir" src="/images/hotels/Kaliningrad/kaliningrad-eco-traktir.jpg" />
    ...
    <div className="row">
      <div className="col-xs-12">
        <NavLink to="/city/kaliningrad/hotels/eco/smile">
          <img className="hotels-image" alt="smile" src="/images/hotels/Kaliningrad/kaliningrad-eco-smile.jpg" />
