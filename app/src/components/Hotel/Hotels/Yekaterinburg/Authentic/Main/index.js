...
// Code
const YekaterinburgAuthenticMain = () => (
    ...
    <div className="row">
      <div className="col-xs-12">
        <NavLink to="/city/yekaterinburg/hotels/authentic/red">
          <img className="hotels-image" alt="red" src="/images/hotels/Yekaterinburg/yekaterinburg-authentic-red.jpg" />
    ...
    <div className="row">
      <div className="col-xs-12">
        <NavLink to="/city/yekaterinburg/hotels/authentic/chekhov">
          <img className="hotels-image" alt="chekhov" src="/images/hotels/Yekaterinburg/yekaterinburg-authentic-chekhov.jpg" />
    ...
    <div className="row">
      <div className="col-xs-12">
        <NavLink to="/city/yekaterinburg/hotels/authentic/renomme">
          <img className="hotels-image" alt="renomme" src="/images/hotels/Yekaterinburg/yekaterinburg-authentic-renomme.jpg" />
