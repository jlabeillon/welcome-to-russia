    ...
    <div className="row">
      <div className="col-xs-12">
        <NavLink to="/city/yekaterinburg/hotels/eco/bolshoy">
          <img className="hotels-image" alt="bolshoy" src="/images/hotels/Yekaterinburg/yekaterinburg-eco-bolshoy.jpg" />
    ...
    <div className="row">
      <div className="col-xs-12">
        <NavLink to="/city/yekaterinburg/hotels/eco/ural">
          <img className="hotels-image" alt="ural" src="/images/hotels/Yekaterinburg/yekaterinburg-eco-ural.jpg" />
    ...
    <div className="row">
      <div className="col-xs-12">
        <NavLink to="/city/yekaterinburg/hotels/eco/lhouse">
          <img className="hotels-image" alt="lhouse" src="/images/hotels/Yekaterinburg/yekaterinburg-eco-lhouse.jpg" />
