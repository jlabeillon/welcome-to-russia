    ...
    <div className="row">
      <div className="col-xs-12">
        <NavLink to="/city/yekaterinburg/hotels/luxury/hyatt">
          <img className="hotels-image" alt="hyatt" src="/images/hotels/Yekaterinburg/yekaterinburg-luxury-hyatt.jpg" />
    ...
    <div className="row">
      <div className="col-xs-12">
        <NavLink to="/city/yekaterinburg/hotels/luxury/vysotsky">
          <img className="hotels-image" alt="vysotsky" src="/images/hotels/Yekaterinburg/yekaterinburg-luxury-vysotsky.jpg" />
    ...
    <div className="row">
      <div className="col-xs-12">
        <NavLink to="/city/yekaterinburg/hotels/luxury/ramada">
          <img className="hotels-image" alt="ramada" src="/images/hotels/Yekaterinburg/yekaterinburg-luxury-ramada.jpg" />
