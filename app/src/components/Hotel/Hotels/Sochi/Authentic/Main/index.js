        ...
        {/* Header */}
          ...
          <div className="row">
            <div className="col-xs-12">
              ...
              <img className="hotels-image" src="/images/hotels/sochi-authentic-anna.jpg" />
          ...
          <div className="col-xs-12">
            ...
            <img className="hotels-image" src="/images/hotels/sochi-authentic-chebotarev.jpg" />
          ...
          <div className="col-xs-12">
            ...
            <img className="hotels-image" src="/images/hotels/sochi-authentic-tsvetnoy.jpg" />
