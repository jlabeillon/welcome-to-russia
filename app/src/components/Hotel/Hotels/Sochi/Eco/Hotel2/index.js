  ...
  <div className="container">
    ...
    <div className="row">
      ...
      <div className="col-xs-10" id="city-container">
        ...
        <p id="city-description">This property is 4 minutes walk from the beach. Featuring free WiFi, a year-round outdoor pool and a seasonal outdoor pool, Pansionat PrimaVera offers accommodation in Sochi. Guests can enjoy the on-site restaurant. All rooms are equipped with a flat-screen TV with cable channels. A terrace or balcony are featured in certain rooms.</p>
