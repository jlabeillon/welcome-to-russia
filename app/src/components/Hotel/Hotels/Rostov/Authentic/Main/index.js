    ...
    <div className="row">
      <div className="col-xs-12">
        <NavLink to="/city/rostov/hotels/authentic/nabokov">
          <img className="hotels-image" alt="nabokov-hotel" src="/images/hotels/Rostov/rostov-authentic-nabokov.jpg" />
    ...
    <div className="row">
      <div className="col-xs-12">
        <NavLink to="/city/rostov/hotels/authentic/legenda">
          <img className="hotels-image" alt="legenda-hotel" src="/images/hotels/Rostov/rostov-authentic-legenda.jpg" />
    ...
    <div className="row">
      <div className="col-xs-12">
        <NavLink to="/city/rostov/hotels/authentic/petrovsky">
          <img className="hotels-image" alt="petrovsky-hotel" src="/images/hotels/Rostov/rostov-authentic-petrovsky.jpg" />
