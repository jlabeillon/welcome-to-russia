        ...
        {/* Header */}
          ...
          <div className="row">
            <div className="col-xs-12">
              ...
              <img className="hotels-image" src="/images/hotels/rostov-eco-don.jpg" />
          ...
          <div className="col-xs-12">
            ...
            <img className="hotels-image" src="/images/hotels/rostov-eco-dobroslawa.jpg" />
          ...
          <div className="col-xs-12">
            ...
            <img className="hotels-image" src="/images/hotels/rostov-eco-alfa.jpg" />
