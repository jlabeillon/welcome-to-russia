    ...
    <div className="row">
      <div className="col-xs-12">
        <NavLink to="/city/moscow/hotels/authentic/tchaikovsky">
          <img className="hotels-image" alt="tchaikovsky" src="/images/hotels/Moscow/moscow-authentic-tchaikovsky.jpg" />
    ...
    <div className="row">
      <div className="col-xs-12">
        <NavLink to="/city/moscow/hotels/authentic/radisson">
          <img className="hotels-image" alt="radisson" src="/images/hotels/Moscow/moscow-authentic-radisson.jpg" />
    ...
    <div className="row">
      <div className="col-xs-12">
        <NavLink to="/city/moscow/hotels/authentic/ivan">
          <img className="hotels-image" alt="ivan" src="/images/hotels/Moscow/moscow-authentic-ivan.jpg" />
