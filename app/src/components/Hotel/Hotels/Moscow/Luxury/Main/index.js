    ...
    <div className="row">
      <div className="col-xs-12">
        <NavLink to="/city/moscow/hotels/luxury/ararat">
          <img className="hotels-image" alt="ararat" src="/images/hotels/Moscow/moscow-luxury-ararat.jpg" />
    ...
    <div className="row">
      <div className="col-xs-12">
        <NavLink to="/city/moscow/hotels/luxury/regis">
          <img className="hotels-image" alt="regis" src="/images/hotels/Moscow/moscow-luxury-regis.jpg" />
    ...
    <div className="row">
      <div className="col-xs-12">
        <NavLink to="/city/moscow/hotels/luxury/four">
          <img className="hotels-image" alt="four" src="/images/hotels/Moscow/moscow-luxury-four.jpg" />
