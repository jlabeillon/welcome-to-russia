    ...
    <div className="row">
      <div className="col-xs-12">
        <NavLink to="/city/saransk/hotels/luxury/admiral">
          <img className="hotels-image" alt="admiral-hotel" src="/images/hotels/Saransk/saransk-luxury-admiral.jpg" />
    ...
    <div className="row">
      <div className="col-xs-12">
        <NavLink to="/city/saransk/hotels/luxury/victoria">
          <img className="hotels-image" alt="victoria-hotel" src="/images/hotels/Saransk/saransk-luxury-victoria.jpg" />
    ...
    <div className="row">
      <div className="col-xs-12">
        <NavLink to="/city/saransk/hotels/luxury/severny">
          <img className="hotels-image" alt="severny-hotel" src="/images/hotels/Saransk/saransk-luxury-severny.jpg" />
          <p className="hotels-description">Located in Saransk, Severny Zamok Hotel features free WiFi and free private parking. Each room offers a air conditioning and a flat-screen TV with satellite channels. You will also find a fridge. The private bathrooms are fitted with a hairdryer.</p>
        </NavLink>
      </div>
    </div>
