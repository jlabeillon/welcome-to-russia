        ...
        {/* Header */}
          ...
          <div className="row">
            <div className="col-xs-12">
              ...
              <img className="hotels-image" src="/images/hotels/novgorod-authentic-volne.jpg" />
          ...
          <div className="col-xs-12">
            ...
            <img className="hotels-image" src="/images/hotels/novgorod-authentic-joy.jpg" />
          ...
          <div className="col-xs-12">
            ...
            <img className="hotels-image" src="/images/hotels/novgorod-authentic-nikitin.jpg" />
