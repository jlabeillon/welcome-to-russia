        ...
        {/* Header */}
          ...
          <div className="row">
            <div className="col-xs-12">
              ...
              <img className="hotels-image" src="/images/hotels/Novgorod/novgorod-luxury-sova.jpg" />
          ...
          <div className="col-xs-12">
            ...
            <img className="hotels-image" src="/images/hotels/Novgorod/novgorod-luxury-marriott.jpg" />
          ...
          <div className="col-xs-12">
            ...
            <img className="hotels-image" src="/images/hotels/Novgorod/novgorod-luxury-chayka.jpg" />
