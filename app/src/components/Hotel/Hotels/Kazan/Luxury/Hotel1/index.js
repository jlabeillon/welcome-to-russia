  ...
  <div className="container">
    ...
    <div className="row">
      ...
      <div className="col-xs-10" id="city-container">
        ...
        <p id="city-description">Located in the heart of Kazan city, the hotel is a 5-minute walk from historic sites such as the Kazan Kremlin, the National Museum of Tatarstan and Kazan Academic Drama Theatre. Free WiFi and free private parking are available on site. All light and airy rooms offer air conditioning, an electric kettle, minibar, tea/coffee facilities and flat-screen TV with satellite channels. The bathrooms provide a hairdryer. For extra space and city views, select a suite with a separate living area and two bathrooms. Some rooms also offer views of the Saints Peter and Paul Cathedral. European, Russian and Tatar cuisines are served in the hotel’s restaurant. The restaurant also offers breakfast and 24-hour room service. At the end of the day unwind at the lobby bar with a wide selection of wine, whisky and cocktails. Business travellers will appreciate a meeting room for up to 60 guests.</p>
