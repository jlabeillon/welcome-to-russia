  ...
  <div className="container">
    ...
    <div className="row">
      ...
      <div className="col-xs-10" id="city-container">
        ...
        <p id="city-description">The Shalyapin Palace is a 4-star hotel, centrally located in Kazan near the pedestrian zone of Baumana street. The hotel has a total of 123 classically-designed guest rooms, offering the guest a clean and comfortable place to stay. Every morning a rich buffet breakfast is servied in the on-site restaurant. Guests can also enjoy delicious Tatar and Russian cuisine in the Capella Restaurant, which also serves a range of European dishes. The Shalyapins Piano Bar is open 24-hours. All guests of the Shalyapin Palace receive complimentary access to the fitness centre with its indoor swimming pool, gym and sauna. The hotel offers business meeting facilities of different capacity. There is also an on site car parking, available upon request to hotel guests.</p>
